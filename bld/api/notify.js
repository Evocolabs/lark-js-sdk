...
var NotifyAPI = /** @class */ (function (_super) {
    __extends(NotifyAPI, _super);
    function NotifyAPI() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NotifyAPI.prototype.appNotify = function (options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.post('notify/v4/appnotify', options, tenant_access_token)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
